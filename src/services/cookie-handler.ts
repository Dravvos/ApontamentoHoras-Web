...
function setSessionStorage(name: string, val: string) {
...
function deleteSessionStorage(name: string) {
  sessionStorage.removeItem(name);
}


export { setCookie, getCookie, deleteCookie, setSessionStorage, getSessionStorage, deleteSessionStorage }
